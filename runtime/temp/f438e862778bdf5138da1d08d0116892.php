<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"E:\wwwroot\join\public/../application/admin\view\contest\index.html";i:1532707756;s:67:"E:\wwwroot\join\public/../application/admin\view\common\header.html";i:1532707956;s:67:"E:\wwwroot\join\public/../application/admin\view\common\footer.html";i:1538031104;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
	...
	<title>竞赛管理 -- <?php echo SYS_NAME; ?></title>
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div class="form-group clearfix col-sm-1">
                <?php if(authCheck('contest/contestadd')): ?>
                <a href="<?php echo url('contest/contestAdd'); ?>">
                    <button class="btn btn-outline btn-primary" type="button">添加竞赛</button>
                </a>
                <?php endif; ?>
            </div>
            <!--搜索框开始-->
            <form id='commentForm' role="form" method="post" class="form-inline pull-right">
                <div class="content clearfix m-b">
                    <div class="form-group">
                        <input type="text" class="form-control" id="name" name="name" placeholder="输入竞赛名称">
                    </div>
                    <div class="form-group">
            ...
            <div class="example-wrap">
                <div class="example">
                    <table id="cusTable">
                        ...
                        <th data-field="url">竞赛链接</th>
                        <th data-field="os_url">官网链接</th>
...
<script type="text/javascript">
    ...
    function contestDel(id){
        layer.confirm('确认删除此竞赛?', {icon: 3, title:'提示'}, function(index){
            //do something
            $.getJSON("<?php echo url('contest/contestDel'); ?>", {'id' : id}, function(res){
                if(1 == res.code){
