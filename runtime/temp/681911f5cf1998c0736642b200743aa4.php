<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"E:\wwwroot\join\public/../application/admin\view\about\index.html";i:1532707723;s:67:"E:\wwwroot\join\public/../application/admin\view\common\header.html";i:1532707956;s:67:"E:\wwwroot\join\public/../application/admin\view\common\footer.html";i:1538031104;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
	...
	<title>关于管理 -- <?php echo SYS_NAME; ?></title>
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div class="form-group clearfix col-sm-1">
                <?php if(authCheck('about/aboutadd')): ?>
                <a href="<?php echo url('about/aboutadd'); ?>"><button class="btn btn-outline btn-primary" type="button">添加关于</button></a>
                <?php endif; ?>
            </div>
            <!--搜索框开始-->
            <form id='commentForm' role="form" method="post" class="form-inline pull-right">
                <div class="content clearfix m-b">
                    <div class="form-group">
                        <input type="text" class="form-control" id="title" name="title" placeholder="输入关于标题">
                    </div>
                    <div class="form-group">
...
<script type="text/javascript">
    function initTable() {
        ...
        $("#cusTable").bootstrapTable({
            ...
            url: "<?php echo url('about/index'); ?>", //获取数据的地址
            striped: true,  //表格显示条纹
    ...
    function aboutDel(id){
        layer.confirm('确认删除?', {icon: 3, title:'提示'}, function(index){
            //do something
            $.getJSON("<?php echo url('about/aboutDel'); ?>", {'id' : id}, function(res){
                if(1 == res.code){
