<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"E:\wwwroot\join\public/../application/admin\view\links\linksadd.html";i:1532707770;s:67:"E:\wwwroot\join\public/../application/admin\view\common\header.html";i:1532707956;s:67:"E:\wwwroot\join\public/../application/admin\view\common\footer.html";i:1538031104;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
	...
	<title>添加链接 -- <?php echo SYS_NAME; ?></title>
        ...
        <div class="col-sm-8">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="commentForm" method="post" action="<?php echo url('links/linksadd'); ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group col-sm-5">
                                ...
                                <div class="radio i-checks col-sm-4">
                                    <label>
                                        <input type="radio" value="<?php echo $key; ?>" <?php if($key == 1): ?>checked<?php endif; ?> name="status"> <i></i> <?php echo $vo; ?>
                                    </label>
                                </div>
