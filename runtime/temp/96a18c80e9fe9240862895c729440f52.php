<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"E:\wwwroot\join\public/../application/admin\view\college\index.html";i:1532927254;s:67:"E:\wwwroot\join\public/../application/admin\view\common\header.html";i:1532707956;s:67:"E:\wwwroot\join\public/../application/admin\view\common\footer.html";i:1538031104;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
	...
	<title>学院管理 -- <?php echo SYS_NAME; ?></title>
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div class="form-group clearfix col-sm-1">
                <?php if(authCheck('college/collegeadd')): ?>
                <a href="<?php echo url('college/collegeadd'); ?>"><button class="btn btn-outline btn-primary" type="button">添加学院</button></a>
                <?php endif; ?>
            </div>
            <!--搜索框开始-->
            <form id='commentForm' role="form" method="post" class="form-inline pull-right">
                <div class="content clearfix m-b">
                    <div class="form-group">
                        <input type="text" class="form-control" id="name" name="name" placeholder="输入学院名称">
                    </div>
                    <div class="form-group">
...
<script type="text/javascript">
    function initTable() {
        ...
        $("#cusTable").bootstrapTable({
            ...
            url: "<?php echo url('college/index'); ?>", //获取数据的地址
            striped: true,  //表格显示条纹
    ...
    function collegeDel(id){
        layer.confirm('确认删除?', {icon: 3, title:'提示'}, function(index){
            //do something
            $.getJSON("<?php echo url('college/collegeDel'); ?>", {'id' : id}, function(res){
                if(1 == res.code){
