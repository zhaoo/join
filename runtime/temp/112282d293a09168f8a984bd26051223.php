<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"E:\wwwroot\join\public/../application/admin\view\role\index.html";i:1532707827;s:67:"E:\wwwroot\join\public/../application/admin\view\common\header.html";i:1532707956;s:67:"E:\wwwroot\join\public/../application/admin\view\common\footer.html";i:1538031104;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
	...
	<title>角色管理 -- <?php echo SYS_NAME; ?></title>
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div class="form-group clearfix col-sm-1">
                ...
                <a href="<?php echo url('role/roleAdd'); ?>"><button class="btn btn-outline btn-primary" type="button">添加角色名称</button></a>
                <?php endif; ?>
            </div>
            <!--搜索框开始-->
            <form id='commentForm' role="form" method="post" class="form-inline pull-right">
                <div class="content clearfix m-b">
                    <div class="form-group">
                        <input type="text" class="form-control" id="rolename" name="rolename" placeholder="输入角色">
                    </div>
                    <div class="form-group">
