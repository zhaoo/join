<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"E:\wwwroot\join\public/../application/admin\view\message\index.html";i:1532707792;s:67:"E:\wwwroot\join\public/../application/admin\view\common\header.html";i:1532707956;s:67:"E:\wwwroot\join\public/../application/admin\view\common\footer.html";i:1538031104;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
	...
	<title>留言管理 -- <?php echo SYS_NAME; ?></title>
...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div class="form-group clearfix col-sm-1"></div>
            <!--搜索框开始-->
            <form id='commentForm' role="form" method="post" class="form-inline pull-right">
                <div class="content clearfix m-b">
                    <div class="form-group">
                        <input type="text" class="form-control" id="nic_name" name="nic_name" placeholder="输入留言名称">
                    </div>
                    <div class="form-group">
            ...
            <div class="example-wrap">
                <div class="example">
                    <table id="cusTable">
                        ...
                        <th data-field="upload_times">时间</th>
...
<script type="text/javascript">
    ...
    function messageDel(id){
        layer.confirm('确认删除此留言?', {icon: 3, title:'提示'}, function(index){
            //do something
            $.getJSON("<?php echo url('message/messageDel'); ?>", {'id' : id}, function(res){
                if(1 == res.code){
