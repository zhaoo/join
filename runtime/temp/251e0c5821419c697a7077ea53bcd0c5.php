<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"E:\wwwroot\join\public/../application/admin\view\links\index.html";i:1533098732;s:67:"E:\wwwroot\join\public/../application/admin\view\common\header.html";i:1532707956;s:67:"E:\wwwroot\join\public/../application/admin\view\common\footer.html";i:1538031104;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
	...
	<title>链接管理 -- <?php echo SYS_NAME; ?></title>
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            <div class="form-group clearfix col-sm-1">
                <?php if(authCheck('links/linksadd')): ?>
                <a href="<?php echo url('links/linksAdd'); ?>">
                    <button class="btn btn-outline btn-primary" type="button">添加链接</button>
                </a>
                <?php endif; ?>
            </div>
            <!--搜索框开始-->
            <form id='commentForm' role="form" method="post" class="form-inline pull-right">
                <div class="content clearfix m-b">
                    <div class="form-group">
                        <input type="text" class="form-control" id="name" name="name" placeholder="输入链接名称">
                    </div>
                    <div class="form-group">
...
<script type="text/javascript">
    ...
    function linksDel(id){
        layer.confirm('确认删除此链接?', {icon: 3, title:'提示'}, function(index){
            //do something
            $.getJSON("<?php echo url('links/linksDel'); ?>", {'id' : id}, function(res){
                if(1 == res.code){
