<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"E:\wwwroot\join\public/../application/admin\view\about\aboutedit.html";i:1532707719;s:67:"E:\wwwroot\join\public/../application/admin\view\common\header.html";i:1532707956;s:67:"E:\wwwroot\join\public/../application/admin\view\common\footer.html";i:1538031104;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
	...
	<title>编辑关于 -- <?php echo SYS_NAME; ?></title>
        ...
        <div class="col-sm-10">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="commentForm" method="post" action="<?php echo url('about/aboutedit'); ?>">
                        <input type="hidden" name="id" value="<?php echo $about['id']; ?>"/>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">标题：</label>
                            <div class="input-group col-sm-7">
                                <input id="title" type="text" class="form-control" name="title" required="" aria-required="true" value="<?php echo $about['title']; ?>">
                            </div>
                        </div>
                        <div class="form-group">
